...
export default function RandomExerciseScreen() {
      ...
      <View style={styles.exerciseContainer}>
        <View style={styles.exerciseHeader}>
          ...
          <View style={styles.exerciseInfo}>
            <Text style={styles.exerciseCategory}>Catégories aléatoires</Text>
            <Text style={styles.exerciseLevel}>
              {currentExercise.level === 'beginner' ? 'Débutant' : 
               currentExercise.level === 'intermediate' ? 'Intermédiaire' : 'Avancé'}
            </Text>
          </View>
